...
### The deviance was reduced by 363(951-588) points on 713-699=14 degrees of freedom (DF), a significant reduction..
1 - pchisq((951-588), df=(713-699))  ## 0 유의미한 차이가 있고, 모델이 잘 수행한다고 봐야 ??  
...
NULL                              713        951             
Pclass           2     81.4       711        869  < 2e-16 ***
Sex              1    197.4       710        672  < 2e-16 ***
Age              1     23.7       709        648  1.1e-06 ***
SibSp            1     13.9       708        634  0.00019 ***
Parch            1      0.1       707        634  0.75928    
Fare             1      0.8       706        633  0.35847    
Embarked         2      4.4       704        629  0.10924    
maybe_parent     1      1.0       703        628  0.30586    
maybe_child      1      3.3       702        625  0.06899 .  
avg_prob         1     33.2       701        592  8.4e-09 ***
avg_parent_prob  1      3.1       700        588  0.07945 .  
avg_child_prob   1      0.7       699        588  0.41156    
---
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
```
>  * 분산분석(Analysis of variance, ANOVA, 변량분석)은 통계학에서 두 개 이상 다수의 집단을 비교하고자 할 때 집단 내의 분산,  총평균과 각 집단의 평균의 차이에 의해 생긴 집단 간 분산의 비교를 통해 만들어진 F분포를 이용하여 가설검정을 하는 방법이다. 
...
glm(formula = Survived ~ Pclass + Sex + Age + SibSp + Parch + 
    Fare + Embarked + maybe_parent + maybe_child + avg_prob + 
    avg_parent_prob + avg_child_prob, family = binomial("logit"), 
    data = train.batch)

Deviance Residuals: 
   Min      1Q  Median      3Q     Max  
-2.370  -0.503  -0.404   0.563   2.433  

Coefficients:
                  Estimate Std. Error z value Pr(>|z|)    
(Intercept)       4.583981   0.568258    8.07  7.2e-16 ***
Pclass2          -1.014721   0.376548   -2.69  0.00704 ** 
Pclass3          -1.358774   0.387583   -3.51  0.00046 ***
Sexmale          -1.559340   0.321003   -4.86  1.2e-06 ***
Age              -0.034060   0.010318   -3.30  0.00096 ***
SibSp            -0.251189   0.134668   -1.87  0.06215 .  
Parch            -0.109198   0.194657   -0.56  0.57481    
Fare              0.000854   0.002622    0.33  0.74477    
EmbarkedQ         0.028816   0.435883    0.07  0.94729    
EmbarkedS        -0.391841   0.275128   -1.42  0.15438    
maybe_parentTRUE -0.225703   0.425974   -0.53  0.59622    
maybe_childTRUE   0.075726   0.444919    0.17  0.86485    
avg_prob         -1.325760   4.737066   -0.28  0.77958    
avg_parent_prob   0.427873   2.323146    0.18  0.85387    
avg_child_prob   -2.113274   2.565825   -0.82  0.41015    
---
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
...
Residual deviance: 587.76  on 699  degrees of freedom
AIC: 617.8
...
```{r}
Titanic.logit.2 <- glm(Survived ~ Sex + Pclass + Age + SibSp + Title + avg_prob, data = train.batch, family=binomial("logit"))
anova(Titanic.logit.2, test="Chisq")
summary(Titanic.logit.2)
```
```
Call:
glm(formula = Survived ~ Sex + Pclass + Age + SibSp + avg_prob, 
    family = binomial("logit"), data = train.batch)

Deviance Residuals: 
   Min      1Q  Median      3Q     Max  
-2.332  -0.522  -0.402   0.553   2.416  

Coefficients:
            Estimate Std. Error z value Pr(>|z|)    
(Intercept)  4.52839    0.45538    9.94  < 2e-16 ***
Sexmale     -1.42133    0.29710   -4.78  1.7e-06 ***
Pclass2     -1.02080    0.32564   -3.13   0.0017 ** 
Pclass3     -1.38345    0.32689   -4.23  2.3e-05 ***
Age         -0.03761    0.00907   -4.15  3.4e-05 ***
SibSp       -0.28892    0.12034   -2.40   0.0164 *  
avg_prob    -3.28353    0.55469   -5.92  3.2e-09 ***
---
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
...
(Dispersion parameter for binomial family taken to be 1)
    ...
    Null deviance: 950.86  on 713  degrees of freedom
Residual deviance: 595.12  on 707  degrees of freedom
AIC: 609.1
...
![alt text](/resource/k_fold_crossvalidation.PNG)
...
Deviance Residuals: 
   Min      1Q  Median      3Q     Max  
-2.347  -0.520  -0.403   0.540   2.433  

Coefficients:
            Estimate Std. Error z value Pr(>|z|)    
(Intercept)   4.1525     0.4206    9.87  < 2e-16 ***
Sexmale      -1.2811     0.2849   -4.50  6.9e-06 ***
Pclass2      -0.9624     0.3246   -2.97  0.00302 ** 
Pclass3      -1.3000     0.3228   -4.03  5.6e-05 ***
Age          -0.0310     0.0085   -3.65  0.00026 ***
avg_prob     -3.4842     0.5444   -6.40  1.6e-10 ***
---
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
...
(Dispersion parameter for binomial family taken to be 1)
    ...
    Null deviance: 950.86  on 713  degrees of freedom
Residual deviance: 601.92  on 708  degrees of freedom
AIC: 613.9
...
Deviance Residuals: 
   Min      1Q  Median      3Q     Max  
-2.340  -0.527  -0.380   0.572   2.479  

Coefficients:
                         Estimate Std. Error z value Pr(>|z|)    
(Intercept)               4.39308    0.44238    9.93  < 2e-16 ***
Sexmale                  -1.26649    0.28731   -4.41  1.0e-05 ***
Pclass2                  -0.84230    0.32766   -2.57   0.0102 *  
Pclass3                  -1.28945    0.32407   -3.98  6.9e-05 ***
Age                      -0.03084    0.00852   -3.62   0.0003 ***
avg_prob                 -3.38705    0.54730   -6.19  6.1e-10 ***
`I(Embarked == "S")TRUE` -0.48024    0.23063   -2.08   0.0373 *  
---
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
...
(Dispersion parameter for binomial family taken to be 1)
    ...
    Null deviance: 950.86  on 713  degrees of freedom
Residual deviance: 597.61  on 707  degrees of freedom
AIC: 611.6
...
```{r}
set.seed(35)
glm.tune.3 <- train(Survived ~ Sex + Pclass + Age + Title + avg_prob + I(Embarked=="S")
                    , data = train.batch
                    , method = "glm"
                    ,metric = "ROC"
                    , trControl = cv.ctrl)
...
Deviance Residuals: 
   Min      1Q  Median      3Q     Max  
-2.465  -0.527  -0.363   0.528   2.510  

Coefficients: (13 not defined because of singularities)
                         Estimate Std. Error z value Pr(>|z|)    
(Intercept)               16.4832   618.7467    0.03   0.9787    
Sexmale                  -13.7742   618.7468   -0.02   0.9822    
Pclass2                   -0.9400     0.3393   -2.77   0.0056 ** 
Pclass3                   -1.4255     0.3405   -4.19  2.8e-05 ***
Age                       -0.0299     0.0106   -2.83   0.0047 ** 
TitleCol                       NA         NA      NA       NA    
TitleMajor                     NA         NA      NA       NA    
TitleSir                       NA         NA      NA       NA    
...
TitleMrs                 -11.5780   618.7465   -0.02   0.9851    
TitleMs                        NA         NA      NA       NA    
TitleMr                    0.2400     0.5960    0.40   0.6872    
TitleMme                       NA         NA      NA       NA    
TitleMlle                      NA         NA      NA       NA    
TitleMiss                -12.3745   618.7465   -0.02   0.9840    
TitleMaster                1.1150     0.8183    1.36   0.1730    
TitleNoble                     NA         NA      NA       NA    
avg_prob                  -3.0873     0.5981   -5.16  2.4e-07 ***
`I(Embarked == "S")TRUE`  -0.5588     0.2329   -2.40   0.0164 *  
---
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
...
(Dispersion parameter for binomial family taken to be 1)
    ...
    Null deviance: 950.86  on 713  degrees of freedom
Residual deviance: 588.06  on 703  degrees of freedom
AIC: 610.1
...
```{r}
set.seed(35)
glm.tune.5 <- train(Fate ~ Class + I(Title=="Mr") + I(Title=="Noble") + Age + avg_prob + Family + I(Embarked=="S") + I(Title=="Mr"&Class=="Third")
                    , data = train.batch
                    , method = "glm"
                    , metric = "ROC"
                    , trControl = cv.ctrl)
...
Deviance Residuals: 
   Min      1Q  Median      3Q     Max  
-2.967  -0.561  -0.412   0.347   2.439  

Coefficients:
                                          Estimate Std. Error z value Pr(>|z|)    
(Intercept)                                 5.9626     0.6857    8.70  < 2e-16 ***
ClassSecond                                -1.4998     0.4430   -3.39  0.00071 ***
ClassThird                                 -3.4332     0.6477   -5.30  1.2e-07 ***
`I(Title == "Mr")TRUE`                     -3.6533     0.6301   -5.80  6.7e-09 ***
`I(Title == "Noble")TRUE`                  -3.3299     0.7764   -4.29  1.8e-05 ***
Age                                        -0.0291     0.0100   -2.91  0.00364 ** 
avg_prob                                   -2.2605     0.6815   -3.32  0.00091 ***
Family                                     -0.2611     0.0879   -2.97  0.00296 ** 
`I(Embarked == "S")TRUE`                   -0.4928     0.2337   -2.11  0.03495 *  
`I(Title == "Mr" & Class == "Third")TRUE`   2.3587     0.5951    3.96  7.4e-05 ***
---
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
...
(Dispersion parameter for binomial family taken to be 1)
    ...
    Null deviance: 950.86  on 713  degrees of freedom
Residual deviance: 562.68  on 704  degrees of freedom
AIC: 582.7
