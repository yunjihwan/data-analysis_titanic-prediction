...
#### 로지스틱 회귀분석을 통한 변수 최적화
   * [선형회귀](https://ko.wikipedia.org/wiki/%EC%84%A0%ED%98%95_%ED%9A%8C%EA%B7%80)
    * 종속 변수 y와 한 개 이상의 독립 변수 (또는 설명 변수) X와의 선형 상관 관계를 모델링하는 회귀분석
...
```
Call:
glm(formula = Survived ~ Sex + Pclass + Age + avg_prob, family = binomial("logit"), 
    data = train.batch)
...
Coefficients:
                                          Estimate Std. Error z value Pr(>|z|)    
(Intercept)                                6.12777    0.71231    8.60  < 2e-16 ***
ClassSecond                               -1.95084    0.43127   -4.52  6.1e-06 ***
ClassThird                                -4.54488    0.60939   -7.46  8.8e-14 ***
`I(Title == "Mr")TRUE`                    -4.98118    0.54835   -9.08  < 2e-16 ***
`I(Title == "Noble")TRUE`                 -4.48154    0.72792   -6.16  7.4e-10 ***
Age                                       -0.02944    0.00975   -3.02   0.0025 ** 
Family                                    -0.35226    0.08273   -4.26  2.1e-05 ***
`I(Embarked == "S")TRUE`                  -0.55795    0.23065   -2.42   0.0156 *  
`I(Title == "Mr" & Class == "Third")TRUE`  2.72557    0.60693    4.49  7.1e-06 ***
---
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
